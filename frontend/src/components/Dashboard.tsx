      ...
      <div className="flex h-screen">
        ...
        <div className="flex items-center justify-center flex-1">
          <div className="text-center">
            ...
            <h3 className="mb-2 text-lg font-semibold text-gray-900">Carregando dashboard</h3>
        ...
        <div className="p-6 space-y-8">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-2 text-gray-600">Visão geral do seu bot de WhatsApp</p>
            </div>
            <button
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            <div className="lg:col-span-2">
              <div className="overflow-hidden bg-white border border-gray-100 shadow-sm rounded-2xl">
                <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                  ...
                  <p className="mt-1 text-sm text-gray-600">Últimas interações do sistema</p>
                </div>
                ...
                <div className="p-6">
                  {recentActivity.length > 0 ? (
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-start justify-between">
                                <p className="text-sm font-medium leading-relaxed text-gray-900">{activity.content}</p>
                              ...
                              {activity.status && (
                                <span
                                  className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium mt-2 ${getStatusColor(activity.status)}`}
                                >
                                  {activity.status}
                                </span>
                              )}
                    ...
                    <div className="py-12 text-center">
                      ...
                      <h3 className="mb-2 text-lg font-medium text-gray-900">Nenhuma atividade</h3>
                      <p className="text-gray-500">As atividades recentes aparecerão aqui</p>
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="overflow-hidden bg-white border border-gray-100 shadow-sm rounded-2xl">
                <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                  <h3 className="text-lg font-bold text-gray-900">Resumo Rápido</h3>
                </div>
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-lg font-bold text-gray-900">2.3 min</span>
                    </div>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
